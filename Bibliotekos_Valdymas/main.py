...
def main():
    biblioteka = Biblioteka(
        "C:/code/Bibliotekos_Valdymas/Duomenys/Knygos.pkl",
        "C:/code/Bibliotekos_Valdymas/Duomenys/Skaitytojai.pkl",
        "C:/code/Bibliotekos_Valdymas/Duomenys/Bibliotekininkai.pkl"
    )
    while True:
        print(pirmas_meniu())
